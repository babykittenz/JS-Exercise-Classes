...
class Car {
  ...
  fill(gallons){
    ...
    this.milesToEmpty = this.milesToEmpty + (gallons * this.milesPerGallon);
  }
  
}

const blue = new Car('random', 20);
blue.fill(3);
console.log(blue.drive(50000));
...
class Lambdasian {
  ...
  speak(){
    return `Hello my name is ${this.name}, ${this.age} and ${this.location}`;
  }
